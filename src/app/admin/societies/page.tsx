...
import { Building2, FileDown, MapPin, Plus, Search, Shield, Users } from "lucide-react"
        ...
        <div className="p-3 sm:p-4 md:p-6 lg:p-8 w-full max-w-none">
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h1 className="text-3xl font-bold text-foreground mb-1">Societies Directory</h1>
