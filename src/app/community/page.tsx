...
const PostCard = memo(({ post, onLike }: { post: Post; onLike: (id: number) => void }) => (
  <Card hover>
    {/* Post Header */}
    ...
    <div className="flex items-center justify-between pt-4 border-t border-cream-200">
      <div className="flex space-x-6">
        ...
        <button className="flex items-center space-x-2 text-dark-green-600 hover:text-dark-green-800 transition-colors">
